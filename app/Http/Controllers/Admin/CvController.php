...
class CvController extends Controller
{
    ...
    {
        $data = Cv::with('profession','city','category','subcategory','user')->where('id',$id)->first();

...
@section('admin.css')
    ...
    <style>
        .summernote-height[disabled] .note-editable {
            background-color: #f0f0f0; /* Deaktiv görmə */
            cursor: not-allowed; /* İşarəçi */
            pointer-events: none; /* Heç bir tıklanma */
        }
        ...
        <div class="container-fluid">
            ...
            <div class="col-12 mt-1">
                <div class="alert alert-success" role="alert">
                    <div class="alert-body">{{$data->user->name}} {{$data->user->surname}} istifadəçinin cvsi</div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form >
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        <input id="birthday" name="birthday" type="date" class="form-control" disabled
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" name="gender" id="input-gender" disabled>
                                            <option value="">@lang('web.gender')</option>
                                            <option value="man"
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        <label class="checkbox-container">
                                            <input type="checkbox" name="marriage" disabled
                                                   @if(!empty($data['marriage']) && $data['marriage']==1) checked
                                                   @endif value="1">
                                            <span class="checkbox-custom"></span>
                                            <span class="checkbox-label">@lang('web.marriage')</span>
                                        </label>
                                    </div>
                                    <div class="col-lg-6">
                                        <select class="form-control" name="city_id" id="input-city" disabled>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-14">
                                        <textarea class="summernote-height form-control" readonly placeholder="@lang('web.user_description')">
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control"
                                               placeholder="@lang('web.min_salary')" name="min_salary" disabled
                                               value="{!! !empty($data['min_salary'])? $data['min_salary']: '' !!}"/>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control"
                                               placeholder="@lang('web.max_salary')" name="max_salary" disabled
                                               value="{!! !empty($data['max_salary'])? $data['max_salary']: '' !!}"/>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        <select class="form-control" name="profession_id" id="input-type" disabled>
                                            <option value="">@lang('web.professions')</option>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-3">
                                        <select name="work_exp" class="form-control" disabled>
                                            <option value="0"
                                    ...
                                    <div class="col-lg-3">
                                        <select class="form-control" name="type_id" id="input-type" disabled>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-3">
                                        <label class="checkbox-container">
                                            <input type="checkbox" name="not_education" disabled
                                                   @if(empty($data['education'])) checked @endif  value="1">
                                            <span class="checkbox-custom"></span>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-3">
                                        <label class="checkbox-container">
                                            <input type="checkbox" id="control-checkbox" name="not_work_exp" disabled
                                                   @if(empty($data['work_experience'])) checked @endif value="1">
                                            <span class="checkbox-custom"></span>
                                    ...
                                    <div class="tab_inners">
                                        <div class="profile__add-cv__block first-child">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-1">
                                                    <label class="checkbox-container">
                                                        <input value="B" type="checkbox" disabled
                                                ...
                                                <div class="col-lg-1">
                                                    <label class="checkbox-container">
                                                        <input value="C" type="checkbox" disabled
                                                ...
                                                <div class="col-lg-1">
                                                    <label class="checkbox-container">
                                                        <input value="D" type="checkbox" disabled
                                                ...
                                                <div class="col-lg-1">
                                                    <label class="checkbox-container">
                                                        <input value="E" type="checkbox" disabled
                                                ...
                                                <div class="col-lg-3">
                                                    <label class="checkbox-container">
                                                        <input type="checkbox" id="have-car" value="personal_car" disabled
                                            ...
                                            @if(!empty($data['diploma_certificate']))
                                                @foreach(json_decode($data,true)['diploma_certificate'] as $indexAwardsCertificates => $AwardsCertificates)
                                                    <div class="row mb-4">
                                                        <div class="col-lg-4">
                                                            <input type="text" class="form-control"
                                                                   placeholder="Sertifkatın adı" disabled
                                                                   name="awards[{{$indexAwardsCertificates}}][certificates_name]"
                                                                   value="{!! !empty($AwardsCertificates['certificates_name'])? $AwardsCertificates['certificates_name'] : NULL !!}"/>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <input type="text" class="form-control"
                                                                   placeholder="Verilmə tarixi" disabled
                                                                   name="awards[{{$indexAwardsCertificates}}][certificates_date]"
                                                                   value="{!! !empty($AwardsCertificates['certificates_date'])? $AwardsCertificates['certificates_date'] : NULL !!}"/>
                                                        </div>
                                                    </div>`
                                                @endforeach
                                            @endif
                                        ...
                                        <div id="inputTemplateSkill"
                                            ...
                                            @if(!empty($data['work_skills']))
                                                @foreach(json_decode($data,true)['work_skills'] as $indexSkills => $skills)
                                                    <div class="row mb-4">
                                                        <div class="col-lg-4">
                                                            <input type="text" class="form-control" placeholder="Skill" disabled
                                        ...
                                        <div id="inputTemplateLangSkill"
                                            ...
                                            @if(!empty($data['language_skills']))
                                                @foreach(json_decode($data,true)['language_skills'] as $indexLangSkills => $langskills)
                                                    <div class="row mb-4">
                                                        <div class="col-lg-4">
                                                            <select class="form-control" name="lang[{{$indexLangSkills}}][lang]" disabled>
                                                                <option value="" @if(!empty($langskills['lang']) && $langskills['lang'] == "") selected @endif>
                                                                    Dilin adı
                                                                </option>
                                                                <option value="1" @if(!empty($langskills['lang']) && $langskills['lang'] ==1) selected @endif>
                                                                    Azərbaycan dili
                                                                </option>
                                                                <option value="2" @if(!empty($langskills['lang']) && $langskills['lang'] ==2) selected @endif>
                                                                    Rus dili
                                                                </option>
                                                                <option value="3" @if(!empty($langskills['lang']) && $langskills['lang'] ==3) selected @endif>
                                                                    İngilis dili
                                                                </option>
                                                                <option value="4" @if(!empty($langskills['lang']) && $langskills['lang'] ==4) selected @endif>
                                                                    Türk dili
                                                                </option>
                                                                <option value="5" @if(!empty($langskills['lang']) && $langskills['lang'] ==5) selected @endif>
                                                                    Alman dili
                                                                </option>
                                                                <option value="6" @if(!empty($langskills['lang']) && $langskills['lang'] ==6) selected @endif>
                                                                    Fransız dili
                                                                </option>
                                                                <option value="7" @if(!empty($langskills['lang']) && $langskills['lang'] ==7) selected @endif>
                                                                    İspan dili
                                                                </option>
                                                                <option value="8" @if(!empty($langskills['lang']) && $langskills['lang'] ==8) selected @endif>
                                                                    Çin dili (Mandarin)
                                                                </option>
                                                                <option value="9" @if(!empty($langskills['lang']) && $langskills['lang'] ==9) selected @endif>
                                                                    Ərəb dili
                                                                </option>
                                                                <option value="10" @if(!empty($langskills['lang']) && $langskills['lang'] ==10) selected @endif>
                                                                    Portuqal dili
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <select class="form-control" name="lang[{{$indexLangSkills}}][levels]" disabled>
                                                                <option value="0" @if(!empty($langskills['levels']) && $langskills['levels'] =="") selected @endif>
                                                                    Səviyyəniz
                                                                </option>
                                                                <option value="1" @if(!empty($langskills['levels']) && $langskills['levels']==1) selected @endif>
                                                                    Zəif
                                                                </option>
                                                                <option value="2" @if(!empty($langskills['levels']) && $langskills['levels']==2) selected @endif>
                                                                    Orta
                                                                </option>
                                                                <option value="3" @if(!empty($langskills['levels']) && $langskills['levels']==3) selected @endif>
                                                                    Yaxşı
                                                                </option>
                                                                <option value="4" @if(!empty($langskills['levels']) && $langskills['levels']==4) selected @endif>
                                                                    Əla
                                                                </option>
                                                            </select>
                                                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('#addInputUniversity').click(function () {
                var index = $('#inputContainerUniversity').children().length;
                var newInputUniversity = `
                <div class="row mb-4">
                    <div class="col-lg-3">
                        <input type="text" class="form-control" placeholder="Müəsə adı" name="education[${index}][name]"/>
                    </div>
                    <div class="col-lg-3">
                        <input type="text" class="form-control" placeholder="Ixtisas adı" name="education[${index}][specialty_name]"/>
                    </div>
                    <div class="col-lg-2">
                        <input type="date" class="form-control" placeholder="Daxil olduqunuz il" name="education[${index}][start_date]"/>
                    </div>
                    <div class="col-lg-2">
                        <input type="date" class="form-control" placeholder="Bitirdiyiniz il" name="education[${index}][end_date]"/>
                    </div>
                    <div class="col-lg-2">
                        <label class="checkbox-container">
                            <input type="checkbox" name="education[${index}][now_reading]" value="1">
                            <span class="checkbox-custom"></span>
                            <span class="checkbox-label">Hal-hazırda təhsil alıram</span>
                        </label>
                    </div>
            ...
            $('#addInputExperiences').click(function () {
                var indexExperiences = $('#inputContainerExperiences').children().length;
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-2">
                        <label class="checkbox-container">
                            <input type="checkbox" name="experiences[${indexExperiences}][now_work]" value="1">
                            <span class="checkbox-custom"></span>
                            <span class="checkbox-label">Hal-hazırda işləyirəm</span>
                        </label>
                    </div>
            ...
            $('#addInputAwardsCertificates').click(function () {
                var indexAwardsCertificates = $('#inputContainerAwardsCertificates').children().length;
            ...
            $('#addInputPortfolio').click(function () {
                var indexPortfolio = $('#inputContainerPortfolio').children().length;
            ...
            $('#addInputSkill').click(function () {
                var indexSkill = $('#inputContainerSkill').children().length;
                var newInputSkill = `
                                    <div class="row mb-4">
                                        <div class="col-lg-4">
                                            <input type="text" class="form-control" placeholder="Skill"
                                                   name="skill[${indexSkill}]"/>
                                        </div>
                                    </div>`;
                $('#inputContainerSkill').append(newInputSkill);
            });
            $('#addInputLangSkill').click(function () {
                var indexLangSkill = $('#inputContainerLangSkill').children().length;
                var newInputLangSkill = `
                                     <div class="row mb-4">
                                        <div class="col-lg-4">
                                            <select class="form-control" name="lang[${indexLangSkill}][lang]">
                                        ...
                                        <div class="col-lg-4">
                                            <select class="form-control" name="lang[${indexLangSkill}][levels]">
